...
//           
//               if (den == 0) {
//               bm_fputs(0,"\nSW ERROR: DIV BY 0 - QUITING SIMULATION\n\n") ; 
//               sim_finish() ; // finish	
//           	return 0;		/* If trap returns... */
//               }
//           
//               /* Left-justify denominator and count shift */
//               while ((long long int) den >= 0) {
//           	den <<= 1;
//           	qbit <<= 1;
//               }
//               while (qbit) {
...
//  		          
//  		long long int rem ;
//  		long long int v_div10 = bm_udivmoddi4(v,10,&rem);
//  		
//  		
//  		char v_rem10 = (char) rem ; // (v - 10*v_div10) ;
//  		
//  		
//  	    s[si++] =(char)('0') + v_rem10 ; 
//  	    v = v_div10 ;
